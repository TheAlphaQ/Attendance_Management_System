...
<body>
	...
	<center>
	   <p><b>ATTENDANCE MANAGER</b></p>
		...
		<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFzmo3JquummKiRTU3gvVz2ANxDGXMsHRKZw&usqp=CAU" class="mt-4" alt="admin logo" height="150" width="150"> 
		<br>
		<br>
...
{ $email=$_POST['email'];
  $pass=$_POST['password'];
  $select="select s_id from student where email= '$email' AND password ='$pass';";
$ros=mysqli_query($con,$select);
$rows=mysqli_num_rows($ros);
if($rows>0)
{ 
	$_SESSION['sid']=mysqli_fetch_array(mysqli_query($con,$select))[0];
